...
<body>
    ...
    <div class="container-fluid mt-3">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <select class="form-select" name="department" onchange="form.submit()">
                        ...
                        ?>
                            <option value="<?= $row['dno'] ?>" <?php if ($row['dno'] == $department) echo 'selected'; ?>>
                                <?= $row['name'] ?></option>
                        <?php
                        }
                        ?>
        ...
        <p class="d-flex justify-content-end">
            ...
            &nbsp;&nbsp;
            <a href="emp-export-excel.php?department=<?= $department ?>" class="btn btn-danger" target="_blank"> <i class="fas fa-file-excel"></i>&nbsp;<span style="font-family: Times New Roman;">Export to
                    Excel</span></a>
        </p>
        ...
        <table class="table table-hover table-bordered w-100">
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            <td colspan="5" class="fw-bold text-primary" style="background: #D9D9D9;">
                                <?php echo "$department: " . LakLao($row1[0]) ?></td>
                            <td class="fw-bold text-primary text-end" style="background: #D9D9D9;">
                                <?= number_format($row1[0]) ?></td>
                        </tr>
                    <?php
                    }
                    ?>
                ...
                ?>
                <tr>
                    <td colspan="5" class="fw-bold text-danger" style="background: #D9D9D9;">ລວມທັງໝົດ:
                        <?= LakLao($sum) ?></td>
                    <td class="fw-bold text-danger text-end" style="background: #D9D9D9;"><?= number_format($sum) ?>
                    </td>
                </tr>
            </tbody>
        </table>
